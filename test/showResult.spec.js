...
describe("Showing results", function () {
  ...
  xit("filters the result by question title", function (done) {
    co(function *(){
      yield [
  ...
  xit("filters the result by from and to date", function (done) {
    co(function *(){
      var t1 = utils.yyyymmdd_to_date('2017-01-01');
      var t2 = utils.yyyymmdd_to_date('2017-01-15');
      var t3 = utils.yyyymmdd_to_date('2017-01-31');
      var t4 = utils.yyyymmdd_to_date('2017-02-01');
      ...
      filterPostData.from = '2017-01-15';
      filterPostData.to = '2017-01-31';
  ...
  xit("filters the result by tag", function (done) {
    co(function *(){
      yield [
  ...
  xit('filters the results by several tags', function (done) {
    co(function *(){
      yield [
